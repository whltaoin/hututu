...
/** 根据id删除用户 DELETE /api/user/delete */
...
/** 获取用户接口 POST /api/user/get/loginUser */
...
/** 根据id获取用户Vo GET /api/user/get/vo */
...
/** 分页查询用户VO列表 POST /api/user/list/page/vo */
...
/** 添加用户 PUT /api/user/update */
export async function userUpdateUsingPut(
